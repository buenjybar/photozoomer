/**
* @author : Paul Lewis
* https://github.com/GoogleChrome/ui-element-samples/tree/gh-pages/image-zoomer
*/
...
class ImageZoomer {
    ...
    update() {
        ...
        this.ctx.clip();
        this.ctx.closePath();
        this.ctx.drawImage(this.target, -targetX * scaledTargetWidth + 64, -targetY * scaledTargetHeight + 64,
            scaledTargetWidth,
            scaledTargetHeight);
        this.ctx.restore();
